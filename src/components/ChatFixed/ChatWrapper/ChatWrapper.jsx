...
function ChatWrapper({visible,setVisible}) {
  ...
  return (
    <>
      <PageVisibility onChange={ isVisible => setWisibleWindow(isVisible) }></PageVisibility>
    <ContainerWrapper mobile={mobile} visible={visible}>
      <button onClick={clickHandler}>
        {first
          ?
          <>
            <animated.svg style={animate1} width="24" height="30" viewBox="0 0 24 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <animated.svg style={animate2} width="19" height="15" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <animated.svg style={animate3} width="19" height="11" viewBox="0 0 19 11" fill="none" xmlns="http://www.w3.org/2000/svg">
